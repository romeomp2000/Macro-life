...
class NutrientIndicator extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    double valor = calculateProgress(percent);
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            alignment: Alignment.topLeft,
            child:
                Text.rich(TextSpan(text: '${amount}g', children: <InlineSpan>[
              TextSpan(
                text: valor > 1.0 ? 'más' : ' restantes',
...
double calculateProgress(double progressPercent) {
  ...
  double progress = 1 - (progressPercent / 100);
