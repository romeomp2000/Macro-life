...
class PesasScreen extends StatelessWidget {
  ...
  const PesasScreen({super.key, this.entrenamiento, this.id});
  @override
  Widget build(BuildContext context) {
    ...
    if (id != null) {
      ...
      if (entrenamiento?.intensidad == 'Levantamiento de pesas') {
        controller.ejercioSlicer.value = 0.0;
        controller.intensidad.value = Intensidad.ligero;
        controller.ejercicio.value = 'Levantamiento de pesas';
