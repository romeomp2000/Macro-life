...
class ClientesEditarScreen extends StatelessWidget {
  const ClientesEditarScreen({super.key});
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Get.find<ClientesEditarController>().delete(),
          ),
        ],
      ),
      body: const SafeArea(
...
class Formulario extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ClientesEditarController>(
      builder: (controller) {
        return Column(
          children: [
            Obx(
  ...
  Step datosCliente(ClientesEditarController controller) {
    return Step(
      title: const Text(
        'DATOS DEL CLIENTE',
...
Step direccionFiscal(ClientesEditarController controller) {
  return Step(
...
Step datosFacturacion(ClientesEditarController controller) {
  return Step(
    state: StepState.editing,
    title: const Text(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(
              () => CustomDropdownSearch(
                label: 'Estatus',
                items: controller.optionsEstatus,
                selectedItem: controller.estatusSelected.value,
                onChanged: (value) => controller.estatusSelected.value = value,
                validator: controller.validateDrop,
              ),
            ),
          ],
