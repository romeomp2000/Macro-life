...
class ProductosListaController extends GetxController {
  ...
  final PagingController<int, ProductoModel> pagingController =
      PagingController(firstPageKey: 0);

  ProductosListaController() {
  ...
  Future<void> fetchItems(int pageKey) async {
    try {
      ...
      final response = await apiService.fetchData('productos/obtener',
          method: Method.POST, body: body);

      final impuestosList = (response['productos'] as List)
