...
class SeriesListaController extends GetxController {
  ...
  final PagingController<int, SerieModel> pagingController =
      PagingController(firstPageKey: 0);

  SeriesListaController() {
  ...
  Future<void> fetchItems(int pageKey) async {
    try {
      ...
      final response = await apiService.fetchData('series/obtener',
          method: Method.POST, body: body);

      final impuestosList = (response['series'] as List)
